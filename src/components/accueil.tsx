      ...
      <div className="container">
        <div className="content">
          ...
          <div className="quisuisje">
            ...
            <p>
            Je suis peut-être la solution à votre problème alors <a href={process.env.PUBLIC_URL + '/pdf/CV_COTREL_Timothee_Dev_Fullstack.pdf'} target="blank"> téléchargez mon cv au format PDF!
              </a>
            </p>
          </div>
        </div>
